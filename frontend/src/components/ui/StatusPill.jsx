...
const MAP = {
  ...
  DRAFT: { cls: 'pill-warning', icon: 'bi-pencil-square', label: 'Nháp' },
  PENDING_APPROVAL: { cls: 'pill-info', icon: 'bi-hourglass-split', label: 'Chờ duyệt' },
  APPROVED: { cls: 'pill-violet', icon: 'bi-patch-check-fill', label: 'Đã duyệt' },
